...
const bohoHair = [
  { name: "Body Wave", image: "/collections/boho-body-wave.avif", alt: "Official Wynn Essentials 18-inch Body Wave human hair bulk product image", href: "https://wynnessentials.us/products/18-body-wave-human-hair-bulk-natural-color-boho-braid-ready" },
  { name: "Bohemian Curl", image: "/collections/boho-bohemian-curl.webp", alt: "Official Wynn Essentials 18-inch Bohemian Curl human hair bulk product image", href: "https://wynnessentials.us/products/18-bohemian-curl-human-hair-bulk-natural-color-boho-braid-essential" },
  { name: "Deep Wave", image: "/collections/boho-deep-wave.avif", alt: "Official Wynn Essentials 18-inch Deep Wave human hair bulk product image", href: "https://wynnessentials.us/products/18-deep-wave-human-hair-bulk-natural-color-defined-texture-for-elevated-braid-styles" },
  { name: "Spanish Curl", image: "/collections/boho-spanish-curl.avif", alt: "Official Wynn Essentials 18-inch Spanish Curl human hair bulk product image", href: "https://wynnessentials.us/products/18-spanish-curl-human-hair-bulk-natural-color-signature-boho-texture" },
];
const shoppableCare = [
  { name: "Nourish", detail: "Organic Oil Blend", image: "/shoppable/nourish-orange.png", alt: "Nourish Organic Oil Blend held against a vivid orange background", href: "https://wynnessentials.us/products/nourish-hair-oil" },
  { name: "Grow", detail: "Organic Hair Growth Oil", image: "/shoppable/grow-model.jpeg", alt: "Model with voluminous textured hair holding Grow Oil", href: "https://wynnessentials.us/products/organic-hair-grow-oil" },
  { name: "Grow", detail: "Scalp & Length Support", image: "/shoppable/grow-lineup.png", alt: "Grow Oil bottle held in front of a coordinated product lineup", href: "https://wynnessentials.us/products/organic-hair-grow-oil" },
  { name: "Soft Life Bonnet", detail: "Satin Hair Protection", image: "/shoppable/pink-scarf.jpeg", alt: "Model protecting her hair with a pink Wynn Essentials satin scarf", href: "https://wynnessentials.us/products/soft-life-bonnet" },
  { name: "Edge Control", detail: "Hydrating Styling Essential", image: "/shoppable/edge-control-model.jpeg", alt: "Model showing smooth styled edges while holding Edge Control", href: "https://wynnessentials.us/products/edge-control" },
  { name: "Heritage Hold", detail: "Satin Scrunchie Set", image: "/shoppable/heritage-hold-street.jpeg", alt: "Heritage Hold scrunchie styled around a sleek bun", href: "https://wynnessentials.us/products/untitled-feb20_17-40" },
  { name: "Nourish", detail: "Moisture-Sealing Oil", image: "/shoppable/nourish-model.jpeg", alt: "Model smiling while holding Nourish Oil", href: "https://wynnessentials.us/products/nourish-hair-oil" },
  { name: "Relief", detail: "Organic Scalp Oil", image: "/shoppable/relief-gift.jpeg", alt: "Relief Organic Oil Blend presented in Wynn Essentials gift packaging", href: "https://wynnessentials.us/products/relief-hair-oil" },
  { name: "Grow", detail: "For Stronger-Looking Hair", image: "/shoppable/grow-sleek.jpeg", alt: "Grow Oil displayed in front of long sleek hair", href: "https://wynnessentials.us/products/organic-hair-grow-oil" },
  { name: "Hydrate", detail: "Herbal Hair Mist", image: "/shoppable/hydrate-results.png", alt: "Hydrate Mist shown beside a defined curl result", href: "https://wynnessentials.us/products/hydrating-herbal-leavein-hair-mist" },
  { name: "Lathyr", detail: "Gentle Cleansing Shampoo", image: "/shoppable/lathyr-pour.jpeg", alt: "Lathyr Gentle Cleansing Shampoo being poured into a hand", href: "https://wynnessentials.us/products/lathyr" },
  { name: "Lathyr", detail: "Wash Day Essential", image: "/shoppable/lathyr-bag.jpeg", alt: "Lathyr shampoo displayed with a Wynn Essentials shopping bag", href: "https://wynnessentials.us/products/lathyr" },
  { name: "Hydrate + Nourish", detail: "Daily Moisture Pair", image: "/shoppable/hydrate-nourish.jpeg", alt: "Hydrate Mist and Nourish Oil held together", href: "https://wynnessentials.us/products/wellness-bundle" },
  { name: "Soft Life Bonnet", detail: "Satin Hair Protection", image: "/shoppable/bonnet-group.png", alt: "Four women wearing Soft Life Bonnets in different colors", href: "https://wynnessentials.us/products/soft-life-bonnet" },
  { name: "Soft Life Bonnet", detail: "Overnight Protection", image: "/shoppable/bonnet-bedroom.png", alt: "Woman adjusting a Soft Life Bonnet in her bedroom", href: "https://wynnessentials.us/products/soft-life-bonnet" },
  { name: "Uplyft", detail: "Moisture Rich Conditioner", image: "/shoppable/uplyft-texture.jpeg", alt: "Rich white conditioner texture displayed on a hand", href: "https://wynnessentials.us/products/uplyft" },
];
...
function Invitation({ manual, onDone }: { manual: boolean; onDone: () => void }) {
  ...
  return <ModalShell label="Wynn Essentials invitation" onClose={finish} className={`invitation ${stage}`}>
    ...
    {stage === "sealed" ? <div className="sealed-copy">
      ...
      <p className="presented">Presented by Wynn Essentials<br />www.wynnessentials.us</p>
  ...
  return <div className="site">
    ...
    <main id="main">
      ...
      <section className="editorial-shop editorial-shop-dark section" aria-labelledby="editorial-everyday"><div className="section-heading"><div><p className="eyebrow">CARE IN REAL LIFE</p><h2 id="editorial-everyday">Wellness, Styled<br/>Your Way.</h2></div><p>From wash day to protective styling, tap any image to shop the product shown.</p></div><div className="editorial-grid editorial-grid-wide">
        ...
        <a className="editorial-card editorial-video-card" href="https://wynnessentials.us/products/wellness-bundle" aria-label="Shop the Hair Wellness Bundle"><video src="/shoppable/wynn-care-video.mp4" muted loop playsInline autoPlay preload="metadata" style={{display:"block",width:"100%",aspectRatio:"2 / 3",objectFit:"cover",background:"#0d0c0b"}}/><span><b>The Wynn Method</b><small>Complete Hair Wellness Bundle</small><em>Shop now</em></span></a>
        <article className="editorial-card editorial-video-card" aria-label="Shop the Wynn Essentials oil trio"><video src="/shoppable/care-video-2.mov" muted loop playsInline autoPlay preload="metadata" style={{display:"block",width:"100%",aspectRatio:"2 / 3",objectFit:"cover",background:"#0d0c0b"}}/><span><b>Essential Oil Care</b><small>Grow · Relief · Nourish</small><span style={{display:"flex",flexWrap:"wrap",gap:".4rem",marginTop:".65rem"}}><a href="https://wynnessentials.us/products/organic-hair-grow-oil" style={{color:"inherit",textDecoration:"underline"}}>Grow</a><a href="https://wynnessentials.us/products/relief-hair-oil" style={{color:"inherit",textDecoration:"underline"}}>Relief</a><a href="https://wynnessentials.us/products/nourish-hair-oil" style={{color:"inherit",textDecoration:"underline"}}>Nourish</a></span></span></article>
        <a className="editorial-card editorial-video-card" href="https://wynnessentials.us/products/relief-hair-oil" aria-label="Shop Relief Organic Oil Blend"><video src="/shoppable/care-video-3.mov" muted loop playsInline autoPlay preload="metadata" style={{display:"block",width:"100%",aspectRatio:"2 / 3",objectFit:"cover",background:"#0d0c0b"}}/><span><b>Relief</b><small>Organic Oil Blend Hydration</small><em>Shop now</em></span></a>
      </div></section>
      ...
      <section id="ingredients" className="ingredients section"><div className="section-heading"><p className="eyebrow">FORMULA LIBRARY</p><h2>Ingredients With Purpose</h2></div><div>{Object.entries(ingredientDescriptions).map(([name,description])=>{const photo=ingredientImages[name];const needsBackdrop=name==="Rosemary"||name==="Grapeseed Oil";return <article key={name}><a className={`ingredient-image${needsBackdrop?` ingredient-image--backdrop ${name==="Rosemary"?"ingredient-image--rosemary":"ingredient-image--grapeseed"}`:""}`} href={photo.source} aria-label={`View ${name} photo source`}><img src={photo.src} alt={photo.alt} width="1000" height="750" loading="lazy"/></a><h3>{name}</h3><p>{description}</p><a href="#shop">View applicable products</a></article>})}</div></section>
      ...
      <section className="bundle section"><div className="section-heading"><p className="eyebrow">THE FOUR-STEP SYSTEM</p><h2>Hair Wellness Bundle</h2><p>Your complete system for cleansing, conditioning, daily hydration, and moisture-sealing care.</p></div><div className="bundle-gallery">
      ...
      <section className="newsletter"><p className="eyebrow">THE WYNN EDIT</p><h2>Good Hair Information<br />Belongs in Your Inbox.</h2><p>Receive routine guidance, ingredient education, product releases, and early access from Wynn Essentials.</p><form onSubmit={(e:FormEvent)=>{e.preventDefault();setNotice("Thanks. The signup adapter is ready for Wynn Essentials' email provider.");(e.currentTarget as HTMLFormElement).reset();}}><label>Email address<input required type="email" placeholder="you@example.com"/></label><label>Phone number (optional)<input type="tel" placeholder="(555) 555-5555"/></label><label className="consent"><input required type="checkbox"/> I agree to receive marketing messages.</label><button className="button">Join the List</button><small>{brandConfig.consent}</small></form></section>
    </main>
    <footer id="footer"><div className="footer-brand"><span className="logo"><BrandLogo /></span><p>Healthy hair is a practice.</p><small>{brandConfig.founder.ownership}<br/>{brandConfig.founder.established}<br/>{brandConfig.founder.location}</small></div>{Object.entries({Shop:["All Products","Best Sellers","Bundles","Gift Cards","Shop by Style"],Discover:["The Wynn Method","Routine Finder","Ingredient Library","Hair Wellness Journal","Our Story"],Help:["Contact","Shipping","Returns","FAQ","Track Order","Accessibility"],Legal:["Privacy","Terms","Refund Policy","Cookie Preferences"]}).map(([title,links])=><div key={title}><h3>{title}</h3>{links.map(x=><a key={x} href="#">{x}</a>)}</div>)}<div className="footer-bottom"><button className="text-button" onClick={()=>setInvitation("manual")}>View Invitation</button><div><a href="#social">Instagram</a><a href="#social">TikTok</a><a href="#social">Pinterest</a><a href="#social">YouTube</a></div><span>© {new Date().getFullYear()} Wynn Essentials. All rights reserved.</span></div></footer>
    ...
    {product&&<ProductDetail product={product} add={add} onClose={()=>{setProduct(null);history.replaceState(null,"",location.pathname)}}/>}
  </div>;
}
