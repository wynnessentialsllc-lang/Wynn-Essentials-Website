...
export default function WynnShop() {
  ...
  return <div className="site">
    ...
    <main id="main">
      <section className="hero"><div className="hero-copy"><p className="eyebrow">TEXTURED-HAIR WELLNESS, MADE INTENTIONAL</p><h1 id="main-heading" tabIndex={-1}>Healthy Hair<br />Is a Practice.</h1><p>Moisture, strength, scalp, and styling essentials created for textured hair and the routines that keep it healthy.</p><div className="actions"><button className="button" onClick={()=>scroll("shop")}>Shop the Essentials</button><button className="outline-button" onClick={()=>scroll("routine-finder")}>Find My Routine</button></div><small>Made for curls, coils, braids, locs, and protective styles.</small></div><div className="hero-image"><video src="/hero-wellness-practice-v3.mp4" poster="/hero-wellness-practice.jpeg" muted loop playsInline autoPlay preload="metadata" aria-label="Model with textured hair surrounded by Wynn Essentials products and styling tools"/></div></section>
