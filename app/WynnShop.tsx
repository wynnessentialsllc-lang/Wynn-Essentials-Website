...
export default function WynnShop() {
  ...
  return <div className="site">
    ...
    <main id="main">
      ...
      <section id="boho-hair" className="boho-hair section" aria-labelledby="boho-hair-heading"><div className="boho-editorial"><div className="boho-portrait"><figure><img src="/collections/boho-lifestyle-braids.webp" alt="Model with long boho braids and curly ends, gold hoops and chain, against a tan backdrop" width="900" height="1196" loading="lazy"/></figure></div><div className="boho-intro"><p className="eyebrow">PREMIUM HUMAN HAIR</p><h2 id="boho-hair-heading"><span>Meet the Boho Hair</span><em>of Your</em><strong>DREAMS</strong></h2><div className="boho-sky-plane" aria-hidden="true"><svg viewBox="0 0 250 86" role="presentation"><path className="boho-vapor-trail" d="M4 68 C44 90 73 68 96 48 C112 34 126 35 148 42"/><g className="boho-plane" transform="translate(143 16) rotate(-8 42 26)"><path d="M4 33 38 27 61 4 72 6 61 27 91 31 96 39 59 38 45 58 36 57 40 37 10 42Z"/><path d="M63 28 77 17 83 19 77 31Z"/></g></svg></div><p className="boho-lede">Four signature textures in premium 18-inch human hair bulk, ready for lightweight boho braids, knotless styles, and dimensional custom installs.</p><Link className="boho-collection-link" href="/braiding-hair">Shop all braiding hair &amp; bundle guide →</Link><div className="boho-flourish" aria-hidden="true"><span>✦</span><span>✦</span><span>✦</span></div></div></div><div className="boho-product-heading"><p className="eyebrow">FOUR SIGNATURE TEXTURES</p><h3>CHOOSE YOUR DREAM</h3><p>Body Wave <span>·</span> Bohemian Curl <span>·</span> Deep Wave <span>·</span> Spanish Curl</p></div><div className="boho-grid">
