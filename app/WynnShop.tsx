...
const ingredientImages: Record<string, { src: string; alt: string; source?: string }> = {
  ...
  "Vitamin E": { src: "https://commons.wikimedia.org/wiki/Special:Redirect/file/Sample_of_alpha-tocopherol.jpg?width=1000", alt: "Sample of alpha-tocopherol, the form of Vitamin E used in oils, on a white background", source: "https://commons.wikimedia.org/wiki/File:Sample_of_alpha-tocopherol.jpg" },
  Lavender: { src: "https://commons.wikimedia.org/wiki/Special:Redirect/file/Lavandulae_flos_by_Danny_S._-_001.jpg?width=1000", alt: "Lavender flowers on a white background", source: "https://commons.wikimedia.org/wiki/File:Lavandulae_flos_by_Danny_S._-_001.jpg" },
  Peppermint: { src: "https://commons.wikimedia.org/wiki/Special:Redirect/file/Menthae_piperitae_folium_by_Danny_S._-_001.jpg?width=1000", alt: "Peppermint leaves on a white background", source: "https://commons.wikimedia.org/wiki/File:Menthae_piperitae_folium_by_Danny_S._-_001.jpg" },
};
