...
export default function WynnShop() {
  ...
  return <div className="site">
    ...
    <footer id="footer">
      ...
      <div><h3>Discover</h3><Link href="/blog">The Wynn Journal</Link><a href="#the-wynn-method">The Wynn Method</a><a href="#routine-finder">Routine Finder</a><a href="#ingredients">Ingredient Library</a><a href="#essential-oils-care">Essential Oils Care</a><a href="#our-story">Our Story</a></div>
