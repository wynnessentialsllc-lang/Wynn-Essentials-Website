...
export default function WynnShop() {
  ...
  return <div className="site">
    ...
    <main id="main">
      ...
      <section id="boho-hair" className="boho-hair section" aria-labelledby="boho-hair-heading"><div className="boho-editorial"><div className="boho-portrait"><figure><img src="/collections/boho-lifestyle-braids.webp" alt="Model with long boho braids and curly ends, gold hoops and chain, against a tan backdrop" width="900" height="1196" loading="lazy"/></figure></div><div className="boho-intro"><p className="eyebrow">PREMIUM HUMAN HAIR</p><h2 id="boho-hair-heading"><span>Meet the Boho Hair</span><em>of Your</em><strong>DREAMS</strong></h2><div className="boho-sky-plane" aria-hidden="true"><svg viewBox="0 0 250 86" role="presentation"><defs><linearGradient id="bohoVaporFade" x1="0" y1="0" x2="1" y2="0"><stop offset="0" stopColor="#fff" stopOpacity=".18"/><stop offset=".48" stopColor="#fff" stopOpacity=".72"/><stop offset="1" stopColor="#fff" stopOpacity=".96"/></linearGradient><filter id="bohoVaporCloud" x="-20%" y="-60%" width="150%" height="220%"><feTurbulence type="fractalNoise" baseFrequency=".035 .12" numOctaves="2" seed="7" result="noise"/><feDisplacementMap in="SourceGraphic" in2="noise" scale="4"/><feGaussianBlur stdDeviation="2.8"/></filter></defs><path className="boho-vapor-mist" d="M4 68 C44 90 73 68 96 48 C112 34 126 35 148 42"/><path className="boho-vapor-body" d="M4 68 C44 90 73 68 96 48 C112 34 126 35 148 42"/><path className="boho-vapor-trail" d="M4 68 C44 90 73 68 96 48 C112 34 126 35 148 42"/></svg><img className="boho-sky-aircraft" src="/collections/boho-skywriting-plane-v1.png" alt="" width="1536" height="1023"/><img className="boho-tail-emblem" src="/collections/wynn-tail-emblem-v1.png" alt="" width="1080" height="1080"/></div><p className="boho-lede">Choose from four signature textures of premium 18-inch human hair, made to bring the lightweight, dimensional boho styles of your dreams to life.</p><Link className="boho-collection-link" href="/braiding-hair">Shop all braiding hair &amp; bundle guide →</Link><div className="boho-flourish" aria-hidden="true"><span>✦</span><span>✦</span><span>✦</span></div></div></div><div className="boho-product-heading"><p className="eyebrow">FOUR SIGNATURE TEXTURES</p><h3>CHOOSE YOUR DREAM</h3><p>Body Wave <span>·</span> Bohemian Curl <span>·</span> Deep Wave <span>·</span> Spanish Curl</p></div><div className="boho-grid">
