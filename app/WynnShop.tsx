  ...
  return <div className="site">
    ...
    <main id="main">
      ...
      <section id="our-story" className="founder section">
        ...
        <div className="founders-panel"><p className="eyebrow">MEET THE FOUNDERS</p><h3>The Wynn Sisters</h3><p>Patricia Wynn, Karina Wynn, and Sheree Wynn are the three sisters behind Wynn Essentials. Together, they created a family-led brand that makes textured-hair care feel more intentional and less overwhelming. Their collection supports the full routine—from cleansing, conditioning, and daily moisture to scalp care, protective styling, and finishing—so every customer can care for her crown with confidence, consistency, and pride.</p><ul className="founders-list"><li>Patricia Wynn</li><li>Karina Wynn</li><li>Sheree Wynn</li></ul><ul className="founder-facts"><li>{brandConfig.founder.ownership}</li><li>{brandConfig.founder.established}</li><li>{brandConfig.founder.location}</li></ul><div className="founder-gallery"><img src="/collections/wynn-essentials-linen-bag.webp" alt="Wynn Essentials linen drawstring pouch in a kraft gift box" width="900" height="1340" loading="lazy"/><img src="/collections/wynn-essentials-oils-giftbox.webp" alt="Wynn Essentials gift box with Edge Control, Nourish, Relief, and Grow" width="900" height="1348" loading="lazy"/><img src="/collections/wynn-essentials-brand-bag.webp" alt="Wynn Essentials kraft shopping bag with Grow oil and a wooden brush on a table" width="832" height="1248" loading="lazy"/><img src="/collections/wynn-essentials-spa-shelf.webp" alt="Wynn Essentials Lathyr, Uplyft, and Revaivl styled on a spa bathroom shelf" width="900" height="1957" loading="lazy"/><img src="/collections/wynn-essentials-gold-editorial.webp" alt="Wynn Essentials Nourish oil in a gold editorial vanity flat lay" width="900" height="1570" loading="lazy"/><img src="/collections/wynn-essentials-natural-girlies.webp" alt="Wynn Essentials full collection in a basket beside a Natural Girlies magazine" width="900" height="1592" loading="lazy"/><img src="/collections/wynn-essentials-nourish-hair.webp" alt="Nourish oil bottles nestled in styled natural hair" width="900" height="1590" loading="lazy"/><img src="/collections/wynn-essentials-vending-machine.webp" alt="Wynn Essentials branded vending machine stocked with Hydrate on a Los Angeles street" width="900" height="1581" loading="lazy"/></div></div>
      </section>
